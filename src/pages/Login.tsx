                    ...
                    >
                        ...
                        <div className="space-y-2">
                            <p className="text-sm font-black uppercase tracking-widest text-primary/60 flex items-center gap-2">
                                <Info className="w-4 h-4" /> AUTHENTICATION
                            </p>
                            <h1 className="text-3xl font-black tracking-tight leading-tight">
                                Continue <br /> 
                                <span className="gradient-primary-text italic underline decoration-primary/20 decoration-2 underline-offset-8">Thinking.</span>
                            </h1>
                            <p className="text-muted-foreground pt-1">Resume where you left off in your cognitive journey.</p>
                        </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <Input
                                            ...
                                            required
                                            className="pl-12 h-12 rounded-2xl border-border bg-background focus:ring-primary focus:ring-offset-background transition-all duration-300 shadow-sm hover:border-primary/30"
                                            value={email}
                        ...
                        <div className="pt-2 flex flex-col items-center gap-4">
                            ...
                            <p className="text-sm text-center text-muted-foreground font-medium">
                                ...
                                <Link to="/signup" className="text-primary hover:primary-text-shadow transition-all font-black decoration-primary/20 underline decoration-2 underline-offset-4">
                                    Sign Up
                                </Link>
                            </p>
                        </div>
